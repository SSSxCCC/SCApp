...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val programList = listOf(
            Program(R.string.files, R.drawable.ic_files),
            Program(R.string.notebook, R.drawable.ic_notebook),
            Program(R.string.media, R.drawable.ic_media),
            Program(R.string.web, R.drawable.ic_web),
            Program(R.string.download, R.drawable.ic_download),
            Program(R.string.timer, R.drawable.ic_timer),
            Program(R.string.recorder, R.drawable.ic_recorder),
            Program(R.string.opengl, R.drawable.ic_opengl),
        )
